...
const Hyperspeed = ({
  ...
  theme = 'dark' // Add theme prop to trigger re-render
}) => {
  ...
  useEffect(() => {
    ...
    const cssColors = {
      roadColor: getCSSColor('--bg-secondary'),
      islandColor: getCSSColor('--bg-primary'),
      background: getCSSColor('--bg-primary'),
      shoulderLines: getCSSColor('--text-primary'),
      brokenLines: getCSSColor('--text-muted'),
      leftCars: [
        getCSSColor('--accent-primary'),
        getCSSColor('--primary'),
        getCSSColor('--accent-secondary')
      ],
      rightCars: [
        getCSSColor('--accent-secondary'),
        getCSSColor('--primary'),
      ...
      sticks: getCSSColor('--primary')
    };

    // Merge with provided options
    const mergedOptions = {
      ...effectOptions,
      colors: effectOptions.colors || cssColors
    };
